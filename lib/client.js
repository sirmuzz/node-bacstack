...
class Client extends EventEmitter {
  ...
  _processError(invokeId, buffer, offset, length) {
    ...
    debug.trace('Received error:', result);
  ...
  _processSegment(msg, server, buffer, offset, length) {
    ...
    const moreFollows = msg.type & baEnum.PduConReqBits.MORE_FOLLOWS;
    if (!moreFollows) {
      this._lastSequenceNumber = 0;
    }
  ...
  _processServiceRequest(serviceMap, content, buffer, offset, length) {
    ...
    debug.trace(`Received service request${id}:`, name);
  ...
  readProperty(receiver, objectId, propertyId, options) {
    return new Promise( (resolve, reject) =>{
      ...
      this._addCallback(settings.invokeId, (err, data) => {
        ...
        if (!result) return reject(new Error('INVALID_DECODING'));
   ...
   * });
   */
  readPropertyMultiple(receiver, propertiesArray, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
   ...
   * });
   */
  writePropertyMultiple(receiver, values, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
   ...
   * );
   */
  confirmedCOVNotification(receiver, monitoredObject, subscribeId, initiatingDeviceId, lifetime, values, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
   ...
   * });
   */
  deviceCommunicationControl(receiver, timeDuration, enableDisable, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
   ...
   * });
   */
  reinitializeDevice(receiver, state, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  writeFile(receiver, objectId, position, fileBuffer, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  readFile(receiver, objectId, position, count, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  readRange(receiver, objectId, idxBegin, quantity, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  subscribeCov(receiver, objectId, subscribeId, cancel, issueConfirmedNotifications, lifetime, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  subscribeProperty(receiver, objectId, monitoredProperty, subscribeId, cancel, issueConfirmedNotifications, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  createObject(receiver, objectId, values, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  deleteObject(receiver, objectId, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  removeListElement(receiver, objectId, reference, values, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  addListElement(receiver, objectId, reference, values, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  getAlarmSummary(receiver, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  getEventInformation(receiver, objectId, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  acknowledgeAlarm(receiver, objectId, eventState, ackText, evTimeStamp, ackTimeStamp, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  confirmedPrivateTransfer(receiver, vendorId, serviceNumber, data, options ) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  getEnrollmentSummary(receiver, acknowledgmentFilter, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
  ...
  confirmedEventNotification(receiver, eventNotification, options) {
    return new Promise( (resolve, reject) =>{
      const settings = {
        maxSegments: options.maxSegments || baEnum.MaxSegmentsAccepted.SEGMENTS_65,
        maxApdu: options.maxApdu || baEnum.MaxApduLengthAccepted.OCTETS_1476,
